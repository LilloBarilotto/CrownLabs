...
func (in *AssignedPublicServicePort) DeepCopyInto(out *AssignedPublicServicePort) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AssignedPublicServicePort.
func (in *AssignedPublicServicePort) DeepCopy() *AssignedPublicServicePort {
	if in == nil {
		return nil
	}
	out := new(AssignedPublicServicePort)
	in.DeepCopyInto(out)
	return out
}
...
func (in *InstancePublicExposureStatus) DeepCopyInto(out *InstancePublicExposureStatus) {
	*out = *in
	if in.Ports != nil {
		in, out := &in.Ports, &out.Ports
		*out = make([]AssignedPublicServicePort, len(*in))
		copy(*out, *in)
	}
}
